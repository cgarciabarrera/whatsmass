...
class ReceiversControllerTest < ActionController::TestCase
  ...
  test "should create receiver" do
    assert_difference('Receiver.count') do
      post :create, receiver: { active: @receiver.active, last_sent: @receiver.last_sent, name: @receiver.name, phone: @receiver.phone, sex: @receiver.sex }
    end
  ...
  test "should update receiver" do
    patch :update, id: @receiver, receiver: { active: @receiver.active, last_sent: @receiver.last_sent, name: @receiver.name, phone: @receiver.phone, sex: @receiver.sex }
    assert_redirected_to receiver_path(assigns(:receiver))
  end
